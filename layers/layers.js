...
lyr_Estaciones_SENAMHIestacion_meteorologica_2.set('fieldLabels', {'fid': 'hidden field', 'estacion': 'inline label - always visible', 'latitud': 'inline label - always visible', 'longitud': 'inline label - always visible', 'altura': 'inline label - always visible', 'activo': 'inline label - always visible', 'orden': 'hidden field', 'fecha_inic': 'inline label - always visible', 'cod_omm': 'hidden field', 'cod_oaci': 'hidden field', 'cod_otro': 'hidden field', 'propietari': 'inline label - always visible', 'telefono': 'hidden field', 'direccion': 'hidden field', 'correo': 'hidden field', 'web': 'hidden field', 'observacio': 'hidden field', 'clasificac': 'hidden field', 'operador': 'hidden field', 'financiado': 'hidden field', 'nom_dep': 'inline label - always visible', 'nom_mun': 'inline label - always visible', 'nom_prov': 'inline label - always visible', 'categoria': 'hidden field', 'tipo_estac': 'inline label - always visible', 'nombre_obs': 'hidden field', 'ci_obs': 'hidden field', 'estado': 'hidden field', 'pronostico': 'hidden field', });
